...
- │   └── auth.store.ts      # Аутентификация и пользователи
- │
...
- │   └── env.ts             # Утилиты для определения окружения
- │
- ├── types/                # TypeScript типы
- │   └── index.ts          # Все типы данных (товары, категории, etc.)
- │
- └── public/              # Статические файлы
- └── middleware.ts          # 🔥 НОВОЕ: Middleware для защиты маршрутов
...
- src/store/auth.store.ts - управление аутентификацией
...
- src/providers/AuthProvider.tsx - инициализация аутентификации
